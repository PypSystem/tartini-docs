...
description: "Connect your WhatsApp number to Tartini in minutes, by scanning a code with your phone."
---
...
<AccordionGroup>
  ...
  The QR Code connection depends on the WhatsApp session on your phone. Switching devices, internet outages, or WhatsApp updates can end that session. Just sync it again.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Connect WhatsApp Business API (WABA)" href="/en/canais/whatsapp-business-api">Meta's official connection, more stable.</Card>
