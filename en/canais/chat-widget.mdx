...
<AccordionGroup>
  ...
  Copy the snippet again from **Chave pública & Integração** (Public key & Integration) after saving your changes, and replace the old code on your website. {/* CONFIRMAR: se o widget lê a configuração pela chave pública em tempo real ou só usa o que está gravado no snippet copiado */}
  </Accordion>
