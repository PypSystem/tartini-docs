...
**Cause:** the token was revoked or changed in @BotFather. The old token stops working and the channel stops receiving and sending, but it still shows as **Conectado** (Connected) in the list.
