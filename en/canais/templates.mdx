...
<Warning>
  Deleting a template removes it from Meta and can't be undone. A template used in an active campaign can't be edited or deleted: deactivate the campaign first.
</Warning>
