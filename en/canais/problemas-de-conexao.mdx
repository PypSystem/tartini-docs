...
<CardGroup cols={2}>
  <Card title="Connect WhatsApp by QR Code" href="/en/canais/whatsapp-qr-code">Step-by-step connection by camera or code.</Card>
  <Card title="Connect WhatsApp Business API (WABA)" href="/en/canais/whatsapp-business-api">Prerequisites and connection for the official channel.</Card>
</CardGroup>
