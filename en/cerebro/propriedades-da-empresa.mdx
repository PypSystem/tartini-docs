...
<Note>
  Saving a content edit reprocesses and reindexes the item, which returns to the Processing status for a few moments. Sites registered as a domain root only allow editing the audience, not the content. The editable text limit is 500,000 characters.
</Note>
