...
- A field to chat with the Cérebro. Type a question and the side chat opens already showing the answer.
...
<CardGroup cols={2}>
  <Card title="Register the company's properties" href="/en/cerebro/propriedades-da-empresa">See, filter, and manage everything Tino has already been taught.</Card>
  <Card title="Teach the AI with documents" href="/en/cerebro/documentos">Upload files to the knowledge base.</Card>
  <Card title="Teach the AI with questions and answers" href="/en/cerebro/perguntas-e-respostas">Register question-and-answer pairs.</Card>
  <Card title="Teach the AI with your website" href="/en/cerebro/sites">Sync and index pages from your website.</Card>
  ...
  <Card title="Create compliance rules" href="/en/cerebro/conformidade">Define what Tino can never do.</Card>
  <Card title="Set the AI's hours and time zone" href="/en/cerebro/disponibilidade">Configure when the company is available for service.</Card>
  <Card title="Configure routing" href="/en/cerebro/roteamento">Tell Tino when it should transfer to a person.</Card>
  <Card title="Configure contact fields" href="/en/cerebro/qualificacao">Define the data Tino collects during the conversation.</Card>
  <Card title="Map processes from conversations" href="/en/cerebro/mapeie-processos">Build the playbook for each type of conversation.</Card>
  <Card title="Track the process Catálogo" href="/en/cerebro/consistencia-e-insights">See what's broken in the process registry.</Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Register the company's properties" href="/en/cerebro/propriedades-da-empresa">The full knowledge base, in one list.</Card>
  <Card title="Processes explained" href="/en/cerebro/processos-explicados">What a process is and how it guides Tino.</Card>
</CardGroup>
