...
description: "Understand where all the knowledge, personality, and rules that guide Tino and Sotto live, and where to go to configure each part."
---
...
Tino's suggestions and Scout's findings reach the Overview and the Cérebro screens already with a proposed fix, and a button to accept or correct. At first the Cérebro knows what you registered; over time, it comes to know how the company handles conversations and wants to handle them.
