...
<CardGroup cols={2}>
  <Card title="Map processes from conversations" href="/en/cerebro/mapeie-processos">Build and publish the process before grouping it.</Card>
  <Card title="Track the process Catalog" href="/en/cerebro/consistencia-e-insights">See structural problems in the process records.</Card>
</CardGroup>
