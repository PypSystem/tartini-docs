...
<Note>
  Who can see this: Administrator and Company Manager. Available on all plans. Reviewing process candidates depends on the Scale plan, since processes require that plan.
...
<Note>
  Editing a suggestion before deciding already approves the edited version in the same click. No suggestion applies to conversations before it's approved.
</Note>
...
<CardGroup cols={2}>
  <Card title="Register the company's properties" href="/en/cerebro/propriedades-da-empresa">See the full list of indexed content.</Card>
  <Card title="Map processes from conversations" href="/en/cerebro/mapeie-processos">Review the central queue of process candidates.</Card>
</CardGroup>
