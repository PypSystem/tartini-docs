...
<Note>
  The "ver no diagnóstico" link is only evidence: it shows the problem's impact on real conversations, in Sotto. The fix button is always what actually resolves the problem.
</Note>
...
## The bridge to the diagnosis in Sotto

The Catálogo only looks at the records, independent of real conversations. To see how each process actually performed in service, the diagnosis lives in Sotto, accessible through the "ver no diagnóstico" link on any finding with an associated process.
...
<AccordionGroup>
  ...
  It's not in the Catálogo. That's execution, and it lives in Sotto's diagnosis.
  </Accordion>
</AccordionGroup>
...
<Lista>
  <Artigo titulo="Map processes from conversations" href="/en/cerebro/mapeie-processos">Fix the step-by-step directly at the source.</Artigo>
  <Artigo titulo="See adherence to the processes" href="/en/sotto/processos-e-aderencia">Track, in Sotto, what Tino resolved by following each process.</Artigo>
</Lista>
