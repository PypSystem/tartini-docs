...
When an approved criterion came from a Tino suggestion, the card shows an **Origem** (Source) link pointing to the Cérebro (the company's brain) document it was extracted from.
...
<AccordionGroup>
  ...
  There's no simulation on this screen. To check the behavior, use the Cérebro's test chat.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Set up clarifications" href="/en/cerebro/esclarecimentos">Define when Tino asks for more information.</Card>
  <Card title="Set the AI's hours and time zone" href="/en/cerebro/disponibilidade">Set when the company is available for service.</Card>
</CardGroup>
