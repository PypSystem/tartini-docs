...
<Note>
  The reader doesn't parse commas inside a field, so avoid values with a comma (like "Rua A, 123") directly in the CSV. If you need one, use a semicolon inside the field, not a comma.
</Note>
...
<AccordionGroup>
  ...
  The wizard doesn't validate the format at upload time. Prefer the international format, with the country code, to reduce delivery errors.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Build the structure in Areas and Units" href="/en/equipe/areas-e-unidades">How Units are organized.</Card>
  <Card title="Track the results" href="/en/campanhas/resultados">Where to see how many contacts entered and converted.</Card>
  <Card title="Pull contacts from external systems" href="/en/campanhas/contatos-de-campanha">Connect Varejo Online and SAN.</Card>
</CardGroup>
