...
<CardGroup cols={2}>
  ...
  <Card title="Import campaign contacts" href="/en/campanhas/contatos-e-csv">The CSV format and the import preview.</Card>
  ...
  <Card title="Map processes from conversations" href="/en/cerebro/mapeie-processos">The playbook Tino follows.</Card>
</CardGroup>
