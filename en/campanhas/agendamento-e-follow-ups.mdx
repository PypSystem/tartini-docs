...
<CardGroup cols={2}>
  ...
  <Card title="Set hours and the AI's time zone" href="/en/cerebro/disponibilidade">The availability that feeds the default window.</Card>
  <Card title="Track the results" href="/en/campanhas/resultados">Conversations, conversions, and drop-offs.</Card>
  <Card title="Create WhatsApp message templates" href="/en/canais/templates">Templates required for WABA follow-ups.</Card>
</CardGroup>
