...
<Note>
  While paused, no new contact enters the campaign until you resume it. {/* CONFIRMAR: se follow-ups já agendados para contatos que entraram antes da pausa continuam disparando ou ficam suspensos */}
</Note>
...
<AccordionGroup>
  ...
  New contacts don't enter the campaign while it's paused. {/* CONFIRMAR: se as tentativas de follow-up já agendadas para contatos anteriores continuam sendo enviadas durante a pausa */}
  </Accordion>
