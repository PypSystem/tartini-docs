...
<Note>
  An invalid key shows the alert **Chave API Inválida** (Invalid API key). The key is stored securely and validated when you save it.
</Note>
...
This integration has no form on the screen. To activate or review it, contact the Tartini team.
