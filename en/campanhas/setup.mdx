...
<CardGroup cols={2}>
  <Card title="Connect WhatsApp Business API (WABA)" href="/en/canais/whatsapp-business-api">Connect an official Meta channel.</Card>
  <Card title="Create WhatsApp message templates" href="/en/canais/templates">Create, sync, and track approval.</Card>
  <Card title="Credits explained" href="/en/visao-geral/creditos-explicados">How the monthly allowance works.</Card>
