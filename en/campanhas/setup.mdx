...
<Note>
  If the month's credits run out, a yellow bar warns you at the top of the screen. If the extra margin also runs out, a red bar warns that the AI stops responding and campaigns stop. Both lead straight to **Configurações > Cobrança > Créditos**. See [What happens when credits run out](/en/creditos/quando-os-creditos-acabam).
</Note>
