...
<CardGroup cols={2}>
  ...
  <Card title="Transfer, note, and tag conversations" href="/en/inbox/transfira-notas-e-tags">The tags and notes inside the conversation.</Card>
  <Card title="Handle a conversation" href="/en/inbox/atenda-uma-conversa">Open, reply, attach files, and take over from Tino.</Card>
  <Card title="Read Scout's evaluations" href="/en/scout/avaliacoes">The summary and score for each conversation.</Card>
</CardGroup>
