...
If "Ativar Sotto ao finalizar conversa" is turned on, Sotto generates a summary and a score for the conversation. If the satisfaction survey is active for the channel, the conversation moves to "Aguardando CSAT" and the customer receives the question.
...
<AccordionGroup>
  ...
  It disappears from the active queues. If Sotto is turned on, it gets a summary and a score; if the satisfaction survey is active, the customer receives the question.
  </Accordion>
...
<Lista>
  ...
  <Artigo titulo="Set the conversation rules" href="/en/atendimento/regras-de-conversa">Signature, automatic closing, and active Copilot.</Artigo>
