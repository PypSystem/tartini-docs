---
title: "Close a conversation and send the survey"
...
<CardGroup cols={2}>
  <Card title="Set up the satisfaction survey" href="/en/atendimento/pesquisa-de-satisfacao">Trigger rules and response time limit.</Card>
