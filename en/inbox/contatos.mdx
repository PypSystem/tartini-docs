...
By default the list is sorted by the most recent message.
...
<CardGroup cols={2}>
  <Card title="The contact record" href="/en/inbox/ficha-do-contato">Data, status, fields, notes, and conversations.</Card>
  <Card title="Get to know the Inbox" href="/en/inbox/conheca-o-inbox">The screen, the lists, and conversation statuses.</Card>
  <Card title="Track site visitors" href="/en/inbox/visitantes">Who is browsing through the Chat Widget right now.</Card>
