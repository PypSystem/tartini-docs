...
The **Detalhes** (Details) tab shows the contact card, a summary of the record, the conversation data (status, agent, phone number), and notes. The **Copilot** tab only appears for those with access enabled.
