...
<Lista>
  ...
  <Artigo titulo="Close a conversation and send the survey" href="/en/inbox/encerre-uma-conversa">Close one conversation at a time, with the right reason.</Artigo>
