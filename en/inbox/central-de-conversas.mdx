...
<CardGroup cols={2}>
  ...
  <Card title="Close a conversation and send the survey" href="/en/inbox/encerre-uma-conversa">Close one conversation at a time, with the right reason.</Card>
  <Card title="Set the support SLA" href="/en/atendimento/sla">The maximum response time per channel.</Card>
  <Card title="Scout explained" href="/en/scout/o-scout-explicado">How the conversation's summary and score come about.</Card>
</CardGroup>
