...
<CardGroup cols={2}>
  <Card title="Turn on two-factor authentication" href="/en/conta/autenticacao-em-dois-fatores">One more layer of protection.</Card>
  <Card title="Sign messages" href="/en/inbox/atenda-uma-conversa">Where the signature appears in the conversation.</Card>
</CardGroup>
