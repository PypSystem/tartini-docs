...
<CardGroup cols={2}>
  <Card title="Configuring the Inbox" href="/en/primeiros-passos/guias/configurando-o-inbox">Departments, rules, quick messages, and SLA.</Card>
  <Card title="Training the Cérebro" href="/en/primeiros-passos/guias/treinando-o-cerebro">Knowledge, personality, operations, and processes.</Card>
</CardGroup>
