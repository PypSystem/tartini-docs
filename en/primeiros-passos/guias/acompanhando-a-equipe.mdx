---
title: "Tracking Your Team with Scout and Copilot"
sidebarTitle: "Tracking Your Team"
description: "Turn on Scout, read the Overview, review evaluations, and track performance and satisfaction, with Copilot alongside your agents."
---
...
- [Scout explained](/en/scout/o-scout-explicado).
...
- [Scout explained](/en/scout/o-scout-explicado): the scope bar and the Overview.
...
In the first weeks, open the evaluations and say whether you agree. Correcting a score and explaining why teaches Scout to evaluate the way you do; from then on, the next evaluations come out already calibrated. Start with the low-scoring conversations.

- [Read Scout's evaluations](/en/scout/avaliacoes).
...
- [Track your team's performance](/en/scout/desempenho-da-equipe).
- [See process adherence](/en/scout/processos-e-aderencia) (Scale).
...
- [Track customer satisfaction](/en/scout/satisfacao).
...
Copilot is Scout's feedback applied in real time: it answers the agent based on the Cérebro and, in active mode, suggests the reply and flags when something contradicts the knowledge base. Grant access person by person.
...
<CardGroup cols={2}>
  <Card title="Turning on Tino" href="/en/primeiros-passos/guias/ligando-o-tino">The AI on the front line, with Scout evaluating.</Card>
  <Card title="Operation metrics" href="/en/metricas/operacao">Your team's numbers by period.</Card>
</CardGroup>
