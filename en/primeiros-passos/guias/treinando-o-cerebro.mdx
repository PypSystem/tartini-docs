...
<CardGroup cols={2}>
  <Card title="Turning on Tino" href="/en/primeiros-passos/guias/ligando-o-tino">Put the AI to work.</Card>
  <Card title="Best practices for going live" href="/en/primeiros-passos/boas-praticas/entrar-no-ar">Three ways to start.</Card>
</CardGroup>
