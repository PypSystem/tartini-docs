...
Sotto answers the agent's questions by consulting the Cérebro and what Tino left in the conversation, and it suggests ready-made replies. Access is granted person by person, on the Users screen. Active mode, where it suggests replies on its own, is available on every plan.
