...
description: "Get the Inbox ready for your team: queues, rules, quick messages, Copilot, SLA, and satisfaction surveys."
---
...
5. [Give the team access to Copilot](#step-5-give-the-team-access-to-copilot)
...
These rules apply to every channel: whether the agent's signature is required, whether the person can change the signed name, how long an inactive conversation takes to close on its own, whether Scout evaluates it when it closes, and whether active Copilot comes turned on for new conversations.

- [Set the conversation rules](/en/atendimento/regras-de-conversa).
- [Close a conversation and send the survey](/en/inbox/encerre-uma-conversa).
...
A quick message is ready-made text that a person triggers by typing a slash in the message field. Company-wide ones apply to everyone; each person can also have their own. Start with greetings, closings, and the answers your team repeats most often.

- [Create and use quick messages](/en/inbox/mensagens-rapidas).

---

## Step 5: Give the team access to Copilot

{/* VÍDEO: o Copilot na conversa (60 s) */}

Copilot answers the agent's questions by consulting the Cérebro and what Tino left in the conversation, and it suggests ready-made replies. Access is granted person by person, on the Users screen. Active mode, where it suggests replies on its own, is part of the Scale plan.

- [Invite and manage users](/en/equipe/usuarios): the Copilot access toggle.
...
<CardGroup cols={2}>
  <Card title="Tracking your team" href="/en/primeiros-passos/guias/acompanhando-a-equipe">Scout, evaluations, and performance.</Card>
  <Card title="The contact profile" href="/en/inbox/ficha-do-contato">Everything the company knows about each customer.</Card>
</CardGroup>
