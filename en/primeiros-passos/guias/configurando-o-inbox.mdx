...
These rules apply to every channel: whether the agent's signature is required, whether the person can change the signed name, how long an inactive conversation takes to close on its own, whether Sotto evaluates it when it closes, and whether active Copilot comes turned on for new conversations.
...
SLA sets the maximum time for the first human reply and warns the team before it runs out, with a clock shown on the conversation. The satisfaction survey asks the customer, at the end of support, how it went, and feeds Sotto and the metrics.
...
<Lista>
  <Artigo titulo="Tracking your team" href="/en/primeiros-passos/guias/acompanhando-a-equipe">Sotto, evaluations, and performance.</Artigo>
