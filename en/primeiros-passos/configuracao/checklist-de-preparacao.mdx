...
<CardGroup cols={2}>
  <Card title="Getting Started with Tartini" href="/en/primeiros-passos/guias/comecando-com-o-tartini">The complete guide, step by step.</Card>
  <Card title="Connect WhatsApp via QR Code" href="/en/canais/whatsapp-qr-code">The fastest way to your first channel.</Card>
</CardGroup>
