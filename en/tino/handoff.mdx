...
The conversation follows the team's rules: the automatic closing from Conversation Rules, the channel's SLA, and the satisfaction survey. In Sotto, it counts as a **handoff**: the AI started and the team took over. The score for these conversations appears separately in **Sotto > Satisfação** (Sotto > Satisfaction).
