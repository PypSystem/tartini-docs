...
On the other side, Sotto reads Tino's conversations with the same standard as the team's and points out, in the Cérebro, where the process or instruction needs to change.
...
- **Sotto > Satisfação** (Sotto > Satisfaction): customer scores on conversations resolved by Tino alone (**csat do tino**, Tino's CSAT), shown separately from the team's conversations and the ones it handed off. See [Track customer satisfaction](/en/sotto/satisfacao).
...
<Lista>
  <Artigo titulo="Turn Tino on in a channel" href="/en/tino/ia-por-canal">The AI by channel screen, field by field.</Artigo>
  <Artigo titulo="When Tino hands off the conversation" href="/en/tino/handoff">What the team sees and how to take over.</Artigo>
</Lista>
