...
Where it is: **Sotto > Processos** (Sotto > Processes).

<Steps>
  <Step title="Open the screen">Go to **Sotto > Processos**.</Step>
...
<Lista>
  ...
  <Artigo titulo="Map processes from conversations" href="/en/cerebro/mapeie-processos">How a process is created and maintained.</Artigo>
