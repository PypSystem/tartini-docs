...
Where it is: **Sotto > Desempenho** (Sotto > Performance).

<Steps>
  <Step title="Open the screen">Go to **Sotto > Desempenho**.</Step>
...
## Generate Sotto's Monthly Analysis
...
<Steps>
  ...
  <Step title="Adjust the score if needed">While editing, fill in the adjusted score for the team or the agent and the justification for the adjustment. Leaving it blank keeps Sotto's score.</Step>
...
The agent themselves opens **Sotto > Desempenho** and sees the same numbers and their own monthly analysis, in read-only mode, without the review or approval buttons. This includes the strengths, the areas to improve, and the action plan written for them.
...
<Lista>
  <Artigo titulo="Read Sotto's evaluations" href="/en/sotto/avaliacoes">The conversations that make up the period's score.</Artigo>
  <Artigo titulo="Agree with Sotto or correct the score" href="/en/sotto/concorde-ou-corrija">How the correction factors into the effective score.</Artigo>
  <Artigo titulo="The Sotto Explained" href="/en/sotto/o-sotto-explicado">Roles, plans, and the Sotto menu.</Artigo>
