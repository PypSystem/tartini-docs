...
The Satisfação screen brings together the score the customer gave in the survey with Sotto's read on the conversation, so you can quickly see where the experience is dropping.
...
Where it is: **Sotto > Satisfação** (Sotto > Satisfaction).

<Steps>
  <Step title="Open the screen">Go to **Sotto > Satisfação**.</Step>
...
<Lista>
  ...
  <Artigo titulo="Read Sotto's evaluations" href="/en/sotto/avaliacoes">The full analysis of each conversation.</Artigo>
</Lista>
