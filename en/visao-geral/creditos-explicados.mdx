...
| Every Sotto analysis when a conversation closes | Credits, AI category |
...
Once the month's allowance is exhausted, Tartini uses an extra margin, an advance of up to ten percent of the next cycle's allowance. A yellow banner warns at the top of every screen. When the margin also runs out, the banner turns red and the AI pauses: Tino, Copilot, and Sotto stop until the recharge. The Inbox, channels, and metrics continue.
