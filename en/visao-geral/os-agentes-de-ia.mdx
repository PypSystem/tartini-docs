...
Everything starts from the Cérebro. You hand over your company's material, it learns your standard, and it coordinates the team of agents that works for you. There are four agents, each with its own post and all sharing the same source: Tino talks to the customer, Copilot stays alongside whoever is serving, Scout reads the conversation after it closes, and Quattro writes the operation down. The Cérebro orchestrates the agents, and they talk to one another: when one needs what another knows, it asks, and the answer comes back before the message reaches the customer.
...
See [Scout explained](/en/scout/o-scout-explicado).
...
<CardGroup cols={2}>
  <Card title="The Cérebro explained" href="/en/cerebro/o-cerebro-explicado">Everything starts from it.</Card>
  <Card title="Plans and what each one unlocks" href="/en/visao-geral/planos-e-recursos">Where Tino, Quattro, and active Copilot come in.</Card>
</CardGroup>
