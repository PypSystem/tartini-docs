...
| **Company Manager** | Company | Monitors and manages the whole operation (Inbox, Metrics, Sotto, Campaigns, Cérebro), without account settings: company information, structure, integrations, and billing. |
...
| **Agent** | Unit | Provides service in the Inbox, uses Copilot when granted, and sees their own conversations and their own performance in Sotto. |
...
| Sotto | Everything | Everything | Only their scope | Only their scope | Only their own performance |
...
<AccordionGroup>
  ...
  No. In the Inbox and the Conversation Center, they see only the conversations assigned to them. In Sotto, they see only their own evaluations and their own performance.
  </Accordion>
