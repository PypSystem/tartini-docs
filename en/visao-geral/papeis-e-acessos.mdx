...
| **Agent** | Unit | Provides service in the Inbox, uses Copilot when granted, and sees their own conversations and their own performance in Scout. |
...
<CardGroup cols={2}>
  <Card title="Invite and manage users" href="/en/equipe/usuarios">Grant a person access at one or more points in the structure.</Card>
  <Card title="Areas and Units" href="/en/equipe/areas-e-unidades">Set up your company's structure.</Card>
</CardGroup>
