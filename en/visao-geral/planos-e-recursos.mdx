...
- Sotto: evaluation of closed conversations, feedback to the agent, and performance by Unit, Area, and Company.
...
- **Processos** (Processes) in the Cérebro and Sotto: mapping, groups, and the team's adherence to processes.
...
<Lista>
  <Artigo titulo="The AI agents explained" href="/en/visao-geral/os-agentes-de-ia">Tino, Copilot, Sotto, and the Cérebro.</Artigo>
