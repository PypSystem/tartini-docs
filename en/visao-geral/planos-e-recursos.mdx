...
Scale with dedicated infrastructure, an expanded credit allowance, a negotiated number of Units, and a tailored scope. By quote.
...
<CardGroup cols={2}>
  <Card title="The AI agents explained" href="/en/visao-geral/os-agentes-de-ia">Tino, Copilot, Scout, and the Cérebro.</Card>
  <Card title="Credits explained" href="/en/visao-geral/creditos-explicados">Allowance, consumption, and statement.</Card>
</CardGroup>
