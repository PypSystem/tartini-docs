...
Ratings appear in [Scout, in the Satisfaction section](/en/scout/satisfacao), with the score history by agent and by period.
...
<CardGroup cols={2}>
  <Card title="Track customer satisfaction" href="/en/scout/satisfacao">See the scores and comments collected by the survey.</Card>
  <Card title="Set the conversation rules" href="/en/atendimento/regras-de-conversa">Set up the closing that triggers the survey.</Card>
</CardGroup>
