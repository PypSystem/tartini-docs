...
description: "Define how conversations close on their own, how the agent's signature appears, and when Scout and Copilot come into action."
---
...
<AccordionGroup>
  ...
  Yes. Scout evaluates the conversation when it closes. Without automatic closing, it only runs when someone closes it manually.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Set the service SLA" href="/en/atendimento/sla">Measure the time until the first human response.</Card>
  <Card title="Use Copilot" href="/en/inbox/copilot">See how Copilot helps the agent during the conversation.</Card>
</CardGroup>
