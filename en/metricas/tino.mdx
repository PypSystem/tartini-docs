...
Tino also appears on two other Tartini screens. The processes it follows live in [Processes Explained](/en/cerebro/processos-explicados). The scores it gives to closed conversations live in [Read Sotto's evaluations](/en/sotto/avaliacoes).
