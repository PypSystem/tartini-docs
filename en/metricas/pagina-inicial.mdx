...
<CardGroup cols={2}>
  <Card title="Operation Metrics" href="/en/metricas/operacao">The numbers by period, Unit, and agent.</Card>
  <Card title="Tino Metrics" href="/en/metricas/tino">What Tino resolves and how much it consumes.</Card>
</CardGroup>
