...
<CardGroup cols={2}>
  <Card title="The Metrics Panorama" href="/en/metricas/panorama">The period's executive snapshot, by Area and Unit.</Card>
  <Card title="Operation Metrics" href="/en/metricas/operacao">Volume and origin of conversations by team and Tino.</Card>
  <Card title="Track your credit balance and statement" href="/en/creditos/creditos-e-extrato">How much each conversation consumed.</Card>
  <Card title="Channels Explained" href="/en/canais/canais-explicados">What each channel is and how to connect it.</Card>
</CardGroup>
