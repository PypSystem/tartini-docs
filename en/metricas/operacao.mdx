...
<CardGroup cols={2}>
  ...
  <Card title="Tino Metrics" href="/en/metricas/tino">What the AI delivered and how fast.</Card>
  <Card title="Service SLA" href="/en/atendimento/sla">The deadline that appears in 1ª resposta.</Card>
  <Card title="Use the Conversation Center" href="/en/inbox/central-de-conversas">See the conversations behind each number.</Card>
</CardGroup>
