...
The agent sees the same analysis, with the corrected score and your justification. It's direct feedback on that service, with no need for another conversation.
...
<CardGroup cols={2}>
  <Card title="Read Scout's evaluations" href="/en/scout/avaliacoes">The list of conversations and what the analysis shows.</Card>
  <Card title="Track team performance" href="/en/scout/desempenho-da-equipe">How the correction factors into the team's score.</Card>
  <Card title="The Scout Explained" href="/en/scout/o-scout-explicado">The evaluate, validate, and learn cycle.</Card>
  <Card title="The Cérebro Explained" href="/en/cerebro/o-cerebro-explicado">Where the tone of voice, guideline, and compliance standards live.</Card>
</CardGroup>
