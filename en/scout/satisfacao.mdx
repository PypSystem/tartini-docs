...
<Steps>
  <Step title="Compare Units">In the **csat por unidade** (csat by unit) card, see the score for each Unit the contact belongs to, ordered by the ones with the most responses.</Step>
...
<CardGroup cols={2}>
  <Card title="Configure the satisfaction survey" href="/en/atendimento/pesquisa-de-satisfacao">Turn on the survey by channel.</Card>
  <Card title="The Scout Explained" href="/en/scout/o-scout-explicado">Roles, plans, and the Scout menu.</Card>
  <Card title="Use the Conversation Center" href="/en/inbox/central-de-conversas">Open any conversation in read-only mode.</Card>
  <Card title="Read Scout's evaluations" href="/en/scout/avaliacoes">The full analysis of each conversation.</Card>
</CardGroup>
