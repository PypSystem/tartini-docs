...
<CardGroup cols={2}>
  <Card title="Read Scout's evaluations" href="/en/scout/avaliacoes">The conversations that make up the period's score.</Card>
  <Card title="Agree with Scout or correct the score" href="/en/scout/concorde-ou-corrija">How the correction factors into the effective score.</Card>
  <Card title="The Scout Explained" href="/en/scout/o-scout-explicado">Roles, plans, and the Scout menu.</Card>
  <Card title="Track your credit balance and statement" href="/en/creditos/creditos-e-extrato">The consumption of generating and regenerating the analysis.</Card>
</CardGroup>
