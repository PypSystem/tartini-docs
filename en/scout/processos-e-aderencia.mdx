...
<CardGroup cols={2}>
  ...
  <Card title="The Cérebro Explained" href="/en/cerebro/o-cerebro-explicado">Where processes are registered.</Card>
  <Card title="Map processes from conversations" href="/en/cerebro/mapeie-processos">How a process is created and maintained.</Card>
  <Card title="Plans and what each one unlocks" href="/en/visao-geral/planos-e-recursos">What the Scale plan unlocks beyond Processos.</Card>
</CardGroup>
