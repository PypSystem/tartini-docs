...
Access to Sotto is granted per person, on the Users screen. Active mode is available on every plan and can be turned on by default in Conversation Rules or conversation by conversation.
...
<Lista>
  ...
  <Artigo titulo="Plans and what each one unlocks" href="/en/visao-geral/planos-e-recursos">Where Tino and Quattro come in.</Artigo>
</Lista>
