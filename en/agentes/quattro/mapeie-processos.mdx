...
<Steps>
  <Step title="Evaluate capacity, if available">When there's already a step-by-step, click **Avaliar capacidade** (Evaluate capacity) to see how much of the process Tino resolves on its own, or **Pular por ora** (Skip for now).</Step>
