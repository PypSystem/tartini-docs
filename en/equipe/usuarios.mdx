...
<CardGroup cols={2}>
  <Card title="Build the Structure in Areas and Units" href="/en/equipe/areas-e-unidades">Create the areas and units where users will work.</Card>
  <Card title="Roles and access explained" href="/en/visao-geral/papeis-e-acessos">See what each role can see at each level.</Card>
</CardGroup>
