...
<Steps>
  <Step title="Track the balance">Open [Créditos](/en/creditos/creditos-e-extrato) often, especially near the end of the cycle.</Step>
  <Step title="Increase the allowance or buy credits">In [Assinatura](/en/creditos/assinatura), adjust the monthly allowance or recharge credits for the current cycle.</Step>
  <Step title="Give the team a heads-up">If the AI pauses, let the agents know: they keep replying through the Inbox as usual, without the support of Tino, Copilot, or Scout.</Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Track your credit balance and statement" href="/en/creditos/creditos-e-extrato">See your daily consumption and cycle allowance.</Card>
  <Card title="View your subscription and plan" href="/en/creditos/assinatura">Adjust your allowance or upgrade your plan.</Card>
</CardGroup>
