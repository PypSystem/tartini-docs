...
<AccordionGroup>
  ...
  AI usage, including Tino, Copilot, and Scout, and the messages exchanged on the channels.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="View your subscription and plan" href="/en/creditos/assinatura">See your plan, your monthly allowance, and your account details.</Card>
  <Card title="What happens when credits run out" href="/en/creditos/quando-os-creditos-acabam">Understand the warning thresholds and what stops.</Card>
</CardGroup>
