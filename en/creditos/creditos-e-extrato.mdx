...
<Note>
  When the month's allowance runs out, the AI starts using the extra margin, an advance of up to 10% of the allowance, deducted from the next cycle. See what changes in [What happens when credits run out](/en/creditos/quando-os-creditos-acabam).
</Note>
...
<Note>
  On the day the cycle turns over, the statement shows how much allowance came in and how much of the previous balance expired. Credits don't roll over from one cycle to the next.
</Note>
...
<AccordionGroup>
  ...
  No. The remaining balance expires at the cycle turnover, including recharge packs. On the day of the turnover, the statement shows how much expired.
  </Accordion>
...
<Lista>
  ...
  <Artigo titulo="What happens when credits run out" href="/en/creditos/quando-os-creditos-acabam">Understand the warning banners and what stops.</Artigo>
