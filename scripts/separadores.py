...
PASTAS=["visao-geral","primeiros-passos","cerebro","tino","inbox","canais","campanhas","scout","metricas","equipe","atendimento","creditos","integracoes","conta","agentes","marca","en","es"]
n=0
for pasta in PASTAS:
