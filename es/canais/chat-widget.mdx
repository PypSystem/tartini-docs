...
De forma predeterminada, Tino queda apagado en todo widget nuevo.
...
<AccordionGroup>
  ...
  El código copiado antes carga la configuración anterior. Copia el snippet de nuevo después de guardar los cambios.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Activa Tino en un canal" href="/es/tino/ia-por-canal">Horarios, follow-up y cierre para este canal.</Card>
</CardGroup>
