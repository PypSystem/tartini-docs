...
Por padrão, o Tino fica desligado em todo widget novo.
...
### Onde colo o código no meu site?
...
### Mudei a cor do widget e o site não mudou. Por quê?

O código copiado antes carrega a configuração antiga. Copie o snippet de novo depois de salvar as mudanças.

### Os visitantes aparecem como "Visitante" em vez do nome do cliente. Por quê?
...
<CardGroup cols={2}>
  ...
  <Card title="Ligue o Tino em um canal" href="/tino/ia-por-canal">Horários, follow-up e encerramento para este canal.</Card>
</CardGroup>
